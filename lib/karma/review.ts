/**
 * Калибровка проверяющего (V2).
 *
 * Проверяющий — человек без контекста: без общей шкалы оценки за одно и то же
 ...
 *
 * Модуль чистый: используется и Worker'ом, и страницей проверяющего.
 */
 ...
 * проверяющим — правка одной строки, схема БД (`CHECK(reviewer_slot IN (1,2))`)
 ...
 * защитой от накрутки — с одним проверяющим её нет, и это осознанный размен
 * на время раскатки.
 */
