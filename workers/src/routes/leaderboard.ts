 ...
 * Лидерборды.
 *
 * Сортировка по karma_total — подтверждённой ревью. Другой карму и не бывает:
 * баллы появляются только после оценки посторонним, поэтому накрутить рейтинг
 * записями в одиночку нельзя.
 */
