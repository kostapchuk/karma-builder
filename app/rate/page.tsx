...
/**
 * Экран проверяющего: сюда приводит ссылка `?startapp=r<token>`.
 *
 ...
 * поэтому оценка переехала внутрь Mini App, где проверяющий опознан.
 */
...
export default function RatePage() {
  ...
  const load = useCallback(async (value: string) => {
    try {
      ...
      setPage(data);
      // Ручка стартует с системной подсказки: проверяющему есть от чего
